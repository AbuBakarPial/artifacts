  ...
  return (
    <section id="contact" className="py-24 md:py-32 relative overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-1/4 right-0 w-96 h-96 rounded-full bg-gradient-radial from-primary/10 to-transparent blur-3xl"
      />
              ...
              <div className="mt-8 pt-8 border-t border-border/50">
                ...
                <div className="flex gap-4">
                  <a
                    ...
                    className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center hover:bg-primary/20 text-muted-foreground hover:text-primary transition-all"
                    aria-label="LinkedIn"
                  >
                    <Linkedin size={20} />
                  </a>
          ...
          >
            <div className="glass-card p-8 rounded-2xl">
              ...
              <form className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full flex items-center justify-center gap-2 px-6 py-4 rounded-lg bg-primary text-primary-foreground font-medium hover:bg-primary/90 transition-all hover:scale-[1.02] active:scale-[0.98]"
                >
                  <Send size={18} />
                  Send Message
                </button>
